...
doisCorvos = Bar.create( name: 'Dois Corvos', description: 'Dois Corvos is an independent, family-owned brewery in Lisbon, Portugal. We make distinctive craft beers that are distributed throughout Portugal and beyond. The brewery has a Tap Room in the Marvila neighborhood of Lisbon where all beers are served fresh from the tap. Dois Corvos is known for the wide-range of beers in its portfolio — everything from dependable session beers and IPAs to big barrel aged stouts, experimental ales and mixed fermentations.', street_address: 'R. Cap. Leitão 94, 1950-052, Lisbon', location: 'Marvila', city: 'Lisbon', country: 'Portugal' )



puts 'bars created'

creature = Beer.create(name:'Creature', category: 'American IPA', alcohol:'6.8', ibu: 5, brewery: 'Dois Corvos', description: 'Creature is an IPA featuring distinct American hops, British malt and soft Lisbon water. Aromatic and juicy, vibrant and delicate.')
zeArnaldo = Beer.create(name:'Zé Arnaldo', category: 'Robust Porter', alcohol:'6', ibu: 38, brewery: 'Oitava Colina', description: 'Charm and charisma on a glass, Zé Arnaldo is more than a dark beer. It is a bouquet of roasted, sweet and fruity flavours.')
...
tresCincoUm = Beer.create(name:'+351 Pale Ale', category: 'Pale Ale', alcohol:'3.3', ibu: 2, brewery: 'Cervejaria +351', description: 'Tasting Notes: Medium bitterness with a very soft finish. Aroma of Secondary malt. Pale golden, deep amber color. Irreverent! Happy wedding with: sushi “all you can eat”, seafood, freshly caught fish and cozy soups.')
florinda = Beer.create(name:'Florinda', category: 'Lisbon Lager', alcohol:'3.1', ibu: 2, brewery: 'Oitava Colina', description: 'Sweet and elegant, Florinda is light on the hill. The lightness of a lager, with heavy doses of german Hallertau Mittlefruh.')
nortada = Beer.create(name:'Nortada', category: 'Weiss Bier', alcohol:'2.6', ibu: 4, brewery: 'Nortada', description: 'Born in Bavaria, a style whose production was disputed by the German nobles. Made with wheat malt, it is a refreshing breath with subtle notes of banana. The last time King Kong was seen, he had a box like this under his arm.')
voragem = Beer.create(name:'Voragem', category: 'Black IPA', alcohol:'2.6', ibu: 4, brewery: 'Mean Sardine', description: 'ark beer with a great punch of piney hops in the nose, a well-inserted bitterness, and a light chocolate finish.')
biltre = Beer.create(name:'Biltre', category: 'Pilsner', alcohol:'2.6', ibu: 4, brewery: 'Cerveja Biltre', description: 'A light and very refreshing Pilsner. Clove and banana aromas. Cloudy yellow-straw appearence as a good weiss should look like.')
...
creature = Beer.find_by(name:'Creature')
creature.photo_url = 'https://res.cloudinary.com/di6k1pdz4/image/upload/v1606249754/Beerware/Beers/dois_yy0rws.webp'
creature.save


zeArnaldo = Beer.find_by(name:'Zé Arnaldo')
zeArnaldo.photo_url = 'https://res.cloudinary.com/di6k1pdz4/image/upload/v1606249850/Beerware/Beers/8a_dpwkqp.jpg')
zeArnaldo.save
...
voragem = Beer.find_by(name:'Voragem')
voragem.photo_url = 'https://res.cloudinary.com/di6k1pdz4/image/upload/v1606250123/Beerware/Beers/mean_s_o96ql7.jpg'
voragem.save
...
BarsBeer.create(beer:zeArnaldo, bar: cervejaCanil)
BarsBeer.create(beer:voragem, bar: cervejaCanil)
BarsBeer.create(beer:creature, bar: cervejaCanil)
BarsBeer.create(beer:mickLager, bar: cervejaCanil)
BarsBeer.create(beer:maldita, bar: cervejaCanil)
BarsBeer.create(beer:bornInTheIpa, bar: cervejaCanil)
BarsBeer.create(beer:frankApa, bar: cervejaCanil)
BarsBeer.create(beer:blondie, bar: cervejaCanil)
BarsBeer.create(beer:iggyBop, bar: cervejaCanil)
BarsBeer.create(beer:maldita, bar: cervejaCanil)

BarsBeer.create(beer:zeArnaldo, bar: musaDaBica)
BarsBeer.create(beer:voragem, bar: musaDaBica)
BarsBeer.create(beer:tresCincoUm, bar: musaDaBica)

BarsBeer.create(beer:voragem, bar: outroLado)
...
BarsBeer.create(beer:zeArnaldo, bar: deliriumCafe)
BarsBeer.create(beer:voragem, bar: deliriumCafe)
...
BarsBeer.create(beer:zeArnaldo, bar: cerveteca)
BarsBeer.create(beer:voragem, bar: cerveteca)
BarsBeer.create(beer:creature, bar: cerveteca)
...
BarsBeer.create(beer:zeArnaldo, bar: sputnik)
BarsBeer.create(beer:voragem, bar: sputnik)
BarsBeer.create(beer:creature, bar: sputnik)
...
BarsBeer.create(beer:zeArnaldo, bar: cervejaLince)
BarsBeer.create(beer:voragem, bar: cervejaLince)
BarsBeer.create(beer:creature, bar: cervejaLince)
...
BarsBeer.create(beer:zeArnaldo, bar: duqueBrewpub)
BarsBeer.create(beer:voragem, bar: duqueBrewpub)
BarsBeer.create(beer:creature, bar: duqueBrewpub)
...
BarsBeer.create(beer:zeArnaldo, bar: quimera)
BarsBeer.create(beer:voragem, bar: quimera)
BarsBeer.create(beer:creature, bar: quimera)
...
BarsBeer.create(beer:zeArnaldo, bar: piratasCervejeiros)
BarsBeer.create(beer:voragem, bar: piratasCervejeiros)
BarsBeer.create(beer:creature, bar: piratasCervejeiros)
...
BarsBeer.create(beer:zeArnaldo, bar: amoBrewery)
BarsBeer.create(beer:voragem, bar: amoBrewery)
BarsBeer.create(beer:creature, bar: amoBrewery)
...
BarsBeer.create(beer:zeArnaldo, bar: patoBrewering)
BarsBeer.create(beer:voragem, bar: patoBrewering)
BarsBeer.create(beer:creature, bar: patoBrewering)
...
BarsBeer.create(beer:zeArnaldo, bar: deBru)
BarsBeer.create(beer:voragem, bar: deBru)
...
BarsBeer.create(beer:zeArnaldo, bar: cervejariaArtesanalAdamastor)
BarsBeer.create(beer:voragem, bar: cervejariaArtesanalAdamastor)
BarsBeer.create(beer:creature, bar: cervejariaArtesanalAdamastor)
...
BarsBeer.create(beer:zeArnaldo, bar: florLupulo)
BarsBeer.create(beer:voragem, bar: florLupulo)
BarsBeer.create(beer:creature, bar: florLupulo)
...
BarsBeer.create(beer:zeArnaldo, bar: naMedida)
BarsBeer.create(beer:voragem, bar: naMedida)
BarsBeer.create(beer:creature, bar: naMedida)
...
BarsBeer.create(beer:zeArnaldo, bar: brewpubGallas)
BarsBeer.create(beer:voragem, bar: brewpubGallas)
BarsBeer.create(beer:creature, bar: brewpubGallas)
...
BarsBeer.create(beer:zeArnaldo, bar: hoppyHouseBrewing)
BarsBeer.create(beer:voragem, bar: hoppyHouseBrewing)
BarsBeer.create(beer:creature, bar: hoppyHouseBrewing)
...
BarsBeer.create(beer:zeArnaldo, bar: trevo)
BarsBeer.create(beer:voragem, bar: trevo)
BarsBeer.create(beer:creature, bar: trevo)
...
BarsBeer.create(beer:zeArnaldo, bar: craftyCorner)
BarsBeer.create(beer:voragem, bar: craftyCorner)
...
BarsBeer.create(beer:zeArnaldo, bar: oitavaColinaTaproom)
BarsBeer.create(beer:voragem, bar: oitavaColinaTaproom)
BarsBeer.create(beer:creature, bar: oitavaColinaTaproom)
BarsBeer.create(beer:mickLager, bar: oitavaColinaTaproom)
BarsBeer.create(beer:maldita, bar: oitavaColinaTaproom)

BarsBeer.create(beer:zeArnaldo, bar: oitvaMarques)
BarsBeer.create(beer:voragem, bar: oitvaMarques)
BarsBeer.create(beer:creature, bar: oitvaMarques)
