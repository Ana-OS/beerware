...
piratasCervejeiros = Bar.create( name: 'Piratas Cervejeiros', description: 'Seis intrépidos marujos com sede de conhecimento e vontade de produzir a sua própria cerveja embarcaram nesta aventura. Atracámos na Amadora onde após várias batalhas conquistámos a ambicionada “Tortuga”, a ilha dos piratas. Nascendo assim e oficialmente a Piratas Cervejeiros!', street_address: 'Rua 9 de Abril nº38A 2700-612', location: 'Amadora', city: 'Lisbon', country: 'Portugal' )
amoBrewery = Bar.create( name: 'A.M.O. Brewery', description: 'Wednesday through Friday, A.M.O. Brewery is your ideal place to relax, socialize, and enjoy good music while having some of our fantastic made-on-location beers. Hope to see you soon!', street_address: 'Rua Bernardim Ribeiro 53 1150-069', location: 'Marquês de Pombal', city: 'Lisbon', country: 'Portugal' )
beerCascais = Bar.create( name: 'Beer Cascais', description: 'A BeerCascais apresenta-lhe um catálogo de excelência de cervejas de qualidade superior, para que possa degustar em sua casa o verdadeiro sabor requintado desta bebida milenar.', street_address: 'Mercado da Vila, 2750-529', location: 'Mercado da Vila', city: 'Cascais', country: 'Portugal' )
patoBrewering = Bar.create( name: 'Pato Brewering - Tap Room', description: 'All of our beers are available on tap or in bottle, so you can enjoy them how you like. We welcome outside food and have some menus from local places to order from! We’re happy to host your events! Please contact us if you’d like to book the taproom for a party or event.', street_address: 'Av. Pedro Alvares Cabral, 177, Unit G', location: 'Sintra', city: 'Sintra', country: 'Portugal' )
deBru = Bar.create( name: 'DeBru', description: 'Um espaço de cerveja artesanal como nunca viu. Craft Beer - CoWork - Eventos', street_address: 'Rua Luciano Cordeiro, 2C', location: '', city: 'Lisbon', country: 'Portugal' )
cervejariaArtesanalAdamastor = Bar.create( name: 'Cervejaria Artesanal Adamastor', description: 'No description yet', street_address: 'Rua Marechal Saldanha 12-18, 1200-057, Lisboa', location: 'Bica', city: 'Lisbon', country: 'Portugal' )
florLupulo = Bar.create( name: 'Flor de Lúpulo', description: 'Cerveja artesanal, petiscos e boa companhia! Craft Beer, food and friends!', street_address: 'R. Heróis de Quionga 71-45,', location: 'Arroios', city: 'Lisbon', country: 'Portugal' )
naMedida = Bar.create( name: 'Na Medida', description: 'Seja o seu próprio barman! Venha experimentar diversas cervejas e pague pelo mililitro consumido. Um novo conceito em experimentar cervejas em Cascais, e provar nosso petisco "boquinha de anjo".', street_address: 'R. Freitas Reis 24E, 2750-357 ', location: 'Cascais', city: 'Cascais', country: 'Portugal' )
brewpubGallas = Bar.create( name: '21 Brewpub Gallas', description: 'Portuguese craft beer factory (Cerveja Gallas). Brewpub with 12 taps, fresh craft beer. More than 150 options to choose from, portuguese and International craft beers. Vast bottles and cans available. Hamburguers, salmon sandwich, apetizers.', street_address: 'R. Angelina Vidal 53A, 1170-122', location: 'Anjos', city: 'Lisbon', country: 'Portugal' )
hoppyHouseBrewing = Bar.create( name: 'Hoppy House Brewing', description: 'Como startup portuguesa no mercado das cervejas artesanais, na Hoppy House Brewing encaramos a missão de desenvolver o sector com a mesma paixāo com que nos sentamos à mesa a desfrutar dos nossos produtos e a falar sobre eles.', street_address: 'Rua Nova da Trindade 20, 1200 - 303', location: 'Bairro Alto', city: 'Lisbon', country: 'Portugal' )
trevo = Bar.create( name: 'Trevo', description: 'A Trevo foi criada em 2016 por dois irlandeses e um português. Tiveram a ideia de fazer esta marca depois da vitória de Portugal no Campeonato da Europa de futebol em França nesse ano. Apresentaram algumas receitas no Concurso Nacional de Cerveja Artesanal e conquistaram o segundo lugar na categoria de Double IPA.', street_address: 'R. Rodrigues de Faria 103, 1300-501', location: 'Alcântara', city: 'Lisbon', country: 'Portugal' )
craftyCorner = Bar.create( name: 'Crafty Corner', description: 'Located in a converted warehouse in downtown Lisbon, Crafty Corner’s banquet benches and large elegant shop windows make it the perfect place to breathe in the local scenery, socialise with fellow enthusiasts, and taste Portugal\'s exquisite craft beers.', street_address: 'Travessa Corpo Santo 15, 1200-131', location: 'Cais do Sodré', city: 'Lisbon', country: 'Portugal' )
oitavaColinaTaproom = Bar.create( name: 'Oitava Colina - Taproom', description: 'Mais do que um pub. O nosso primeiro taproom é um destino e uma bandeira do bairro da Graça. No 8A da Rua Damasceno Monteiro ficam as 10 torneiras com uma vista única sobre Lisboa e um ambiente que nos faz sentir em casa. Beer, foods & friends! É o que mais gostamos.', street_address: 'Rua Damasceno Monteiro, nº 8A, Lisboa', location: 'Lisbon', city: 'Lisbon', country: 'Portugal' )
oitvaMarques = Bar.create( name: 'Oitva Marquês', description: 'No 85 da Duque de Loulé vive-se numa paixão frenética entre pizza e cerveja. O Chef Thomas Mancini tira do forno deliciosas pizzas de inspiração napolitana, enquanto que das 14 torneiras de cerveja jorram as mais frescas maravilhas da Oitava Colina.', street_address: 'Av. Duque de Loulé, nº 85, Lisboa', location: 'Marquês de Pombal', city: 'Lisbon', country: 'Portugal' )
