...
creature.photo.attach(io: file, filename: 'filename.png', content_type: 'image/png')
file1 = URI.open('https://res.cloudinary.com/di6k1pdz4/image/upload/v1606249850/Beerware/Beers/8a_dpwkqp.jpg')
zeArnaldo.photo.attach(io: file1, filename: 'filename.png', content_type: 'image/png')
...
voragem.photo.attach(io: file5, filename: 'filename.png', content_type: 'image/png')
